                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        $query_last_id = mysqli_query($conexion, "SELECT MAX(codigo) AS last_id FROM producto");
                                        $result_last_id = mysqli_fetch_assoc($query_last_id);
                                        $next_barcode = isset ($result_last_id['last_id']) ? $result_last_id['last_id'] + 1 : 1; // Si no hay productos, empezar en 1
                                        

                                        // Asegúrate de que solo usas este valor si no se ha ingresado otro manualmente
                                        ...
                                        <input type="text" placeholder="Código de barras se generará automáticamente"
                                            name="codigo" id="codigo" class="form-control"
                                            value="<?php echo $next_barcode; ?>" readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="laboratorio">Lugar</label>
                                        <select id="laboratorio" class="form-control" name="laboratorio" required>
                                            <?php
                                            $query_lab = mysqli_query($conexion, "SELECT * FROM lugar");
                                            while ($datos = mysqli_fetch_assoc($query_lab)) { ?>
                                                <option value="<?php echo $datos['id'] ?>">
                                                    <?php echo $datos['laboratorio'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input id="accion" class="form-check-input" type="checkbox" name="accion"
                                            value="si">
